...
def tmm_eval(sub_image, eval_point, en_plot=False, analytical=False, single_f_idx=None):
    ...
    sub_td = window(sub_td, win_len=8, shift=0, en_plot=False)
    sub_ref_td = window(sub_ref_td, win_len=8, shift=0, en_plot=False)
    ...
    if analytical:
        ...
        try:
            ...
            def cost(p, f_idx):
                ...
                phi_loss = (np.angle(sam_tmm_fd) - phi_[f_idx, 1]) ** 2
