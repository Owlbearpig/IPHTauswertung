...
from functions import f_axis_idx_map, save_array_as_csv
...
save_array_as_csv(absorb_sub, "sub_absorbance", (0.25, 3.0))
...
save_array_as_csv(absorb_film, "film_absorbance", (0.25, 3.0))
